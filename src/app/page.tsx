...
// A four-indicator regional snapshot on the home page; the region page ranks
// all twenty-two. Benchmarks are excluded from both.
    ...
    <div>
      ...
      <section className="mx-auto w-full max-w-6xl px-4 pb-12">
        ...
        <p className="mt-3 text-xs leading-relaxed text-[#8A8A94]">
          ...
          All twenty-two indicators are ranked the same way on the{" "}
          <Link href="/region" className="text-[#52B788] hover:text-[#6ED49C]">
            region page
          </Link>
          .
        </p>
        <RegionTable slugs={SNAPSHOT} />
      </section>
